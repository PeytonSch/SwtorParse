    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 25, 1, 441);
    			...
    			add_location(button0, file, 27, 2, 481);
